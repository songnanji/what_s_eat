    ...
    return Scaffold(
      ...
      body: Center(
        child: Column(
          ...
          children: <Widget>[
            buildMenuButton(
                context, '좋아하는 음식 리스트', Icons.favorite, '/favoriteList'),
            buildMenuButton(
                context, '단골 음식점 및 맛집 리스트', Icons.restaurant, '/favoriteRestaurants'),
            buildMenuButton(
                context, '싫어하는 음식 리스트', Icons.cancel, '/dislikeList'),
          ],
        ),
      ),
    );
